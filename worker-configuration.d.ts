/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a70c7a58bd71a68e418bea8498d854af)
...
declare namespace Cloudflare {
	interface Env {
		...
		SHOPIFY_CLI_PARTNERS_TOKEN: string;
		...
		WOOOD_KV_ID: string;
		STORE_LOCATOR_STATUS_ID: string;
		EXPERIENCE_CENTER_STATUS_ID: string;
		OMNIA_PRICING_STATUS_ID: string;
		OMNIA_PRICING_HISTORY_ID: string;
